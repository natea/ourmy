...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignUser.points_at_deadline'
        db.add_column('ourmy_app_campaignuser', 'points_at_deadline',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampaignUser.points_at_deadline'
        db.delete_column('ourmy_app_campaignuser', 'points_at_deadline')
    ...
    models = {
        ...
        'ourmy_app.action': {
            ...
            'end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
            ...
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)', 'blank': 'True'}),
        ...
        'ourmy_app.campaign': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)', 'blank': 'True'}),
