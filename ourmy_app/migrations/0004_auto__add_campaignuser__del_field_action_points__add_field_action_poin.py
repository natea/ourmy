...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignUser'
        db.create_table('ourmy_app_campaignuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ourmy_app.Campaign'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('bitly_url', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_checked', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('stats', self.gf('django.db.models.fields.TextField')(max_length=400, blank=True)),
        ))
        db.send_create_signal('ourmy_app', ['CampaignUser'])
    ...
    def backwards(self, orm):
        # Deleting model 'CampaignUser'
        db.delete_table('ourmy_app_campaignuser')
    ...
    models = {
        ...
        'ourmy_app.action': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'points_per_click': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'points_to_post': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
        ...
        'ourmy_app.campaignuser': {
            ...
            'bitly_url': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ourmy_app.Campaign']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'stats': ('django.db.models.fields.TextField', [], {'max_length': '400', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'ourmy_app.prize': {
