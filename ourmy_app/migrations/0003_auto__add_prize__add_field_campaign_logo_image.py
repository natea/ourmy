...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Prize'
        db.create_table('ourmy_app_prize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ourmy_app.Campaign'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('logo_image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal('ourmy_app', ['Prize'])

        # Adding field 'Campaign.logo_image'
        db.add_column('ourmy_app_campaign', 'logo_image',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ourmy_app_prize')

        # Deleting field 'Campaign.logo_image'
        db.delete_column('ourmy_app_campaign', 'logo_image')
