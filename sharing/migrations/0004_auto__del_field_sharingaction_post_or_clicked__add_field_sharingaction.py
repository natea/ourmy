...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SharingAction.post_or_clicked'
        db.delete_column('sharing_sharingaction', 'post_or_clicked')

        # Adding field 'SharingAction.post_or_click'
        db.add_column('sharing_sharingaction', 'post_or_click',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SharingAction.post_or_clicked'
        db.add_column('sharing_sharingaction', 'post_or_clicked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SharingAction.post_or_click'
        db.delete_column('sharing_sharingaction', 'post_or_click')
