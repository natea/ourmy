...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SharingUserAction.created_at'
        db.add_column('sharing_sharinguseraction', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 24, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SharingUserAction.created_at'
        db.delete_column('sharing_sharinguseraction', 'created_at')
    ...
    models = {
        ...
        'ourmy_app.action': {
            ...
            'end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
            ...
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)', 'blank': 'True'}),
        ...
        'ourmy_app.campaign': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'blank': 'True'}),
        ...
        'sharing.sharinguseraction': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
