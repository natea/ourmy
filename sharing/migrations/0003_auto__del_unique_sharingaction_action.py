...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SharingAction', fields ['action']
        db.delete_unique('sharing_sharingaction', ['action_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'SharingAction', fields ['action']
        db.create_unique('sharing_sharingaction', ['action_id'])
    ...
    models = {
        ...
        'ourmy_app.action': {
            ...
            'end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'}),
            ...
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'blank': 'True'}),
        ...
        'ourmy_app.campaign': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)', 'blank': 'True'}),
        ...
        'sharing.sharinguseraction': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
