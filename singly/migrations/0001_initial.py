...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SinglyProfile'
        db.create_table('user_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=260, null=True, blank=True)),
            ('singly_id', self.gf('django.db.models.fields.CharField')(max_length=260, null=True, blank=True)),
            ('profiles', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='profile', to=orm['auth.User'])),
        ))
        db.send_create_signal('singly', ['SinglyProfile'])


    def backwards(self, orm):
        # Deleting model 'SinglyProfile'
